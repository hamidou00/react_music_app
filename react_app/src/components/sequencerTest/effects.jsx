    ...
    render() {
        return (
            <div className="effects">
                ...
                <input type="range" name="volume" max="1" step="0.1" value={this.state.volume} onChange={this.handleEffects} list="tickmarks"/>
                ...
                <input type="range" name="vibrato" max={20} step={1} value={this.state.vibrato} onChange={this.handleEffects}/>
